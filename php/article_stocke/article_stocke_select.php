...
$sql = "SELECT Aid, Blibelle, LOCnumeroe, LOCniveaue, Aloc, Aimage, Alibelle
                FROM article_stocke
                INNER JOIN localisation ON Aloc = LOCid
                INNER JOIN type_batiment ON LOCbat = Bcode ORDER BY Blibelle, Alibelle, LOCnumeroe, LOCniveaue ASC ;";
 $db_data = array();
